...
import useHistory from "@/usecase/use-history";
import { answerToQuestion } from "@/prompts/step-qna";
import useSpeech from "@/usecase/use-speech";
import { getCookingInstuction } from "@/prompts/cooking-instruction";
import { Instruction } from "@/entity/recipe/types";
...
const CookingInstructions = () => {
  ...
  useEffect(() => {
    const createModel = async () => {
      const session = getPromptAi();
      const generatedPrompt = getCookingInstuction(dish_name, ingredients);
